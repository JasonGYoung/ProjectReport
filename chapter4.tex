...
Calculator (Non-generated) & 3.50 & 65.75 & 4 \\ \hline
NITF file client (Generated) & 2.00 & 54.49 & 136  \\ \hline
NITF file client (Non-generated) & 2.22 & 65.69 & 93 \\ \hline
\end{tabular}
\end{center}
\end{table}
...
\indent
Furthermore, the generated code has a lower average token count per function than the non-generated code.  This supports the reasoning that the generated code is splitting larger computational problems into smaller tasks.

\indent
In the end, the lower average CCN for generated code is the strongest indicator that larger computational problems are being broken down into smaller ones.  Together, these results all allude to the code generated from TEBNF being less error-prone than the code in non-generated implementations.
